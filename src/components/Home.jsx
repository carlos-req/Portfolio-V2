  ...
  return (
    <div name="home" className='w-full h-screen bg-[#111111] '>
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
          ...
          <h1 className='text-4xl sm:text-7xl font-bold text-zinc-100'>Carlos Requena</h1>
          <h2 className='text-4xl sm:text-7xl font-bold text-zinc-500'>I'm a Front End Developer.</h2>
